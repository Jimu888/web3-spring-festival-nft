...
PNG_CID = "bafybeibgux5cbq7lzxuwfcq6hpiw55zv2wubmd4nwzzmpyy5akgbk3mqoq"
MP4_CID = "bafybeiegsmokh4ma3nz5tgl62xis43efw5oydg6xxdok3mfuumj5f7mfxi"
PNG_NAME = "2026web3-gala.png"
MP4_NAME = "2026web3-gala.mp4"
TOTAL = 2026
...
out_dir = Path(__file__).resolve().parents[1] / "metadata"
...
for token_id in range(TOTAL):
    ...
    obj = {
        ...
        "image": f"ipfs://{PNG_CID}/{PNG_NAME}",
        "animation_url": f"ipfs://{MP4_CID}/{MP4_NAME}",
        "attributes": [
